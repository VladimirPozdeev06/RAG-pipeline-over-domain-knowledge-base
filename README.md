...
| Hybrid + Reranker | 0.570 | 0.518 | $\textcolor{green}{0.700}$ | 0.490 | 0.800 | 0.686 | $\textcolor{green}{0.598}$ | 0.497 | $\textcolor{green}{0.707}$ | 0.554 |
| BGE-M3 + Reranker | $\textcolor{green}{0.592}$ | $\textcolor{green}{0.543}$ | 0.640 | $\textcolor{green}{0.529}$ | $\textcolor{green}{0.820}$ | $\textcolor{green}{0.725}$ | $\textcolor{green}{0.598}$ | $\textcolor{green}{0.530}$ | 0.688 | $\textcolor{green}{0.596}$ |
...
| BGE-M3 | 0.830 | 0.833 | 0.100 | $\textcolor{green}{0.078}$ |
| Hybrid (BGE+BM25) | $\textcolor{green}{0.845}$ | $\textcolor{green}{0.840}$ | $\textcolor{green}{0.060}$ | 0.098 |
...
|---|---|---|---|
| Oracle | 0.745 | $\textcolor{green}{0.503}$ | $\textcolor{green}{0.261}$ |
| BGE-M3 + Reranker | $\textcolor{green}{0.747}$ | 0.477 | 0.173 |
